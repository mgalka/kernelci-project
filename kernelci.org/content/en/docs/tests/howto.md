...
itself.  Existing KernelCI native tests such as `v4l2-compliance` and others
provide good examples for how to do this.  The
...
If you would like to read more about LAVA job definitions, please check the
documentation about [writing
tests](https://docs.lavasoftware.org/lava/writing-tests.html).
